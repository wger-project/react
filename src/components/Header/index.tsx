                        ...
                        <ul className={styles.primaryNav__list}>
                            <li className={styles.nav__item}>
                                ...
                                <div ref={trainingVisibleHook.ref}>
                                    <ul className={styles.subNav}
                                        style={{ display: trainingVisibleHook.isComponentVisible ? "block" : "none" }}>
                                        <TrainingSubMenu />
                                    </ul>
                                </div>
                            ...
                            <li className={styles.nav__item}>
                                ...
                                <div ref={bodyWeightVisibleHook.ref}>
                                    <ul className={styles.subNav}
                                        style={{ display: bodyWeightVisibleHook.isComponentVisible ? "block" : "none" }}>
                                        <BodyWeightSubMenu />
                                    </ul>
                                </div>
                            </li>
                            <li className={styles.nav__item}>
                                ...
                                <div ref={nutritionVisibleHook.ref}>
                                    <ul className={styles.subNav}
                                        style={{ display: nutritionVisibleHook.isComponentVisible ? "block" : "none" }}>
                                        <NutritionSubMenu />
                                    </ul>
                                </div>
                            </li>
                            <li className={styles.nav__item}>
                                ...
                                <div ref={aboutVisibleHook.ref}>
                                    <ul className={styles.subNav}
                                        style={{ display: aboutVisibleHook.isComponentVisible ? "block" : "none" }}>
                                        <div className={styles.about}><Link to="/software/about-us">About us</Link>
                                        </div>
                                        <AboutSubMenu />
                                    </ul>
                                </div>
                        ...
                        <ul className={styles.secondaryNav__list}>
                            <li className={styles.nav__item}>
                                ...
                                <div ref={userVisibleHook.ref}>
                                    <ul className={styles.subNav}
                                        style={{ display: userVisibleHook.isComponentVisible ? "block" : "none" }}>
                                        <UserSubMenu />
                                    </ul>
                                </div>
                            </li>
